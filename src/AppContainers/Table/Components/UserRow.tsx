...
const UserRow = ({ data, className }: { data: UserType, className?: string }) => {
   ...
   return (
      <div className={`${className} pos-r min-h-72. h:s-table-row h:bg-bg-white-fff`}>
         <div className="frc g-16. col-span-2 mr-a ml-24.">
            <Img src={profileImg || '/CriticalIcons/person.svg'} className="h-32. w-32. cover fs0" />
         ...
         <div className='col-span-2'>
            <p className="inline tc-text-dark-393939 ts-15.">{description.length > 50 ? description.slice(0, 40) + '...' : description}</p>
