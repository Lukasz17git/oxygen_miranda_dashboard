...
const Comment = ({ index, openCommentModal, className }) => {
   ...
   return (
      <div className={`${className} p-16 px-20 bc-color-separator bw-1 fc g-8 w-360 fs0 br-12 h:s-comment keen-slider__slide`}>
         <p className="max-h-120 text-ellipsis tc-text-grey-darker tf-app-regular ts-15">{comment.comment}</p>
         <div className="frc g-12">
            ...
            <div className="frc ml-a mt-a mb-4">
               ...
               <ActionIcon onClick={openCommentModal} className="h-36 w-36">
                  <FaExpandAlt className="scale-70 fill-text-dark" />
               </ActionIcon>
            </div>
         </div>
      </div>
